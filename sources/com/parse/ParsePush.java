...
public class ParsePush {
    ...
    public static void sendMessageInBackground(String message, ParseQuery<ParseInstallation> query2) {
        sendMessageInBackground(message, query2, null);
    }
    ...
    public static void sendDataInBackground(JSONObject data2, ParseQuery<ParseInstallation> query2) {
        sendDataInBackground(data2, query2, null);
    }
    ...
    public void setChannels(Collection<String> channels) {
        ...
        Preconditions.checkArgument(z, "channels collection cannot be null");
        for (String channel : channels) {
            ...
            Preconditions.checkArgument(z2, "channel cannot be null");
        }
        this.channelSet = new HashSet();
    ...
    private Task<Void> sendAsync() {
        return buildCommand(ParseUser.getCurrentSessionToken()).executeAsync().continueWith(new Continuation<Object, Void>() {
    ...
    public ParseCommand buildCommand(String sessionToken) {
        ...
        if (this.query != null) {
            command.put("where", (JSONObject) Parse.encode(this.query.getConstraints(), PointerEncodingStrategy.get()));
